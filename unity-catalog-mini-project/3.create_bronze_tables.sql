...
USING json
OPTIONS (path "abfss://bronze@databrickscourseucextdl9.dfs.core.windows.net/drivers.json");
...
USING json
OPTIONS (path "abfss://bronze@databrickscourseucextdl9.dfs.core.windows.net/results.json");
